return {
  ...
  {
    'hrsh7th/nvim-cmp', -- O motor de autocompletion principal
    event = 'InsertEnter', -- Carrega o plugin quando você entra no modo de inserção
    dependencies = {
      'L3MON4D3/LuaSnip', -- Um snippet engine é geralmente necessário
      'saadparwaiz1/cmp_luasnip', -- Integração do nvim-cmp com Luasnip
      'hrsh7th/cmp-nvim-lsp', -- ESSA É A FONTE LSP QUE ESTAVA DANDO ERRO
      'hrsh7th/cmp-buffer',   -- Para completar palavras do buffer
      'hrsh7th/cmp-path',     -- Para completar caminhos de arquivo
      -- 'hrsh7th/cmp-cmdline', -- Se você quiser completion na linha de comando
    },
    config = function()
